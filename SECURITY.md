...
The `Open UI Kit` maintainers take all security issues in the project
seriously. Thank you for improving the security of `Open UI Kit`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`Open UI Kit` leverages GitHub's private vulnerability reporting.
...
reach out via the [Open UI Kit team](https://github.com/orgs/outshift-open/teams/open-ui-kit-admins).
